export const DM_SCRIPTS = [
  ...
  },
  {
    id: 'tower_entrance',
    on: { type: 'PLAYER_INTERACT_ENCOUNTER', id: 'monument_reveal' },
    if: { all: [{ quest: 'ch10', active: true }, { item: 'monument_key' }] },
    pages: [
      { text: 'กุญแจอนุสาวรีย์ในมือคุณเรืองแสงสีม่วงจางๆ เมื่อเข้าใกล้อนุสาวรีย์ เผยให้เห็นรูกุญแจที่ซ่อนอยู่ใต้ฐานหิน' },
      { text: 'เมื่อกุญแจหมุน ฐานหินเลื่อนออก บันไดทอดลึกลงไปในความมืด' }
    ],
    choices: [
      { label: 'ลงไปในหอคอย', do: [{ travel: 'tower' }] },
      { label: 'ยังไม่พร้อม', do: [] }
    ]
  },
  {
    id: 'tower_enter',
    once: true,
    on: { type: 'PLAYER_ENTER_AREA', area: 'tower' },
    if: { quest: 'ch10', active: true },
    delay: 900,
    pages: [
      { text: 'บันไดหินทอดลึกลงไปใต้หมู่บ้านที่เจ้าเคยเรียกว่าบ้าน กำแพงประดับด้วยกระดูก และทุกชิ้นดูเหมือนกำลังมองเจ้าอยู่' }
    ],
    choices: [{ label: 'ก้าวต่อไป', do: [{ narrate: 'หอคอยมีสามชั้น ขึ้นไปทีละชั้นผ่านบันไดวน มรกาฬรออยู่ชั้นบนสุด' }] }]
  },
  {
    id: 'morkal_defeated',
    once: true,
    on: { type: 'PLAYER_ENEMY_DEFEATED', enemyId: 'morkal' },
    delay: 700,
    pages: [
      { text: '"ไม่... ร้อยปี... ร้อยปีของข้า..."' },
      { text: 'ร่างกระดูกแตกเป็นผุยผง แสงม่วงที่ปกคลุมหมู่บ้านมาหลายคืนค่อยๆ จางหาย และเป็นครั้งแรกในรอบนาน ที่เจ้าได้ยินเสียงนกร้องอีกครั้ง' }
    ],
    choices: [{ label: 'กลับไปหาทุกคนที่ค่าย', do: [{ narrate: 'กลับไปที่ค่ายผู้ลี้ภัยในป่าเพื่อบอกข่าวให้ทุกคนรู้' }] }]
  }
]
