...
## รายการที่รอเพิ่ม (Master Plan บท 4-10)

- **มังกรเฒ่าไฟกาฬ** (บท 4, 9, 10) — ผู้ใช้ต้องเลือกและดาวน์โหลด asset เองจากตัวเลือกในเอกสารแผนแม่บท (RPG Enemies: 11 Dragons / Dragon 2d sprite / Pixel Bosses. Yes!) แล้วเพิ่มเครดิตตรงนี้ทันทีที่วางไฟล์จริง
- โซนใหม่ "ถ้ำมังกร" และ "หอคอยมรกาฬ" (บท 4, 10) ตั้งใจใช้ tileset ถ้ำ/ดันเจี้ยนเดิมที่มีเครดิตอยู่แล้วด้านบน ไม่ต้องเพิ่มรายการใหม่หากไม่มีการดาวน์โหลด asset เพิ่ม
